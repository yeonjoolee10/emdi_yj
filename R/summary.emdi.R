...
#' summary has methods for classes "direct", "ebp", "fh" and "fh_tf" and the returned
#' object is suitable for printing  with the \code{print}.
#' @param object an object of type "direct", "ebp", "fh" or "fh_tf", representing point
#' and MSE estimates. Objects differ depending on the estimation method.
#' @param ... additional arguments that are not used in this method.
#' @return an object of type "summary.direct", "summary.ebp", "summary.fh" or
#' "summary.fh_tf" with information about the sample and population data, the
#' usage of transformation, normality tests and information of the model fit.
#' @references
...
#' \code{\link{fh}}, \code{\link{fh_tf}}, \code{\link[MuMIn]{r.squaredGLMM}},
